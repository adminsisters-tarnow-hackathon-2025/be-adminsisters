...
namespace be_adminsisters.Persistence.Migrations
{
    ...
    [Migration("20250606003424_RemoveImgFromDb")]
    partial class RemoveImgFromDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("be_adminsisters.Persistence.Entities.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("be_adminsisters.Persistence.Entities.UserAchievement", b =>
                {
                    ...
                    b.HasKey("UserId", "AchievementId")
                        .HasName("pk_user_achievement");

                    b.HasIndex("AchievementId")
                        .HasDatabaseName("ix_user_achievement_achievement_id");
            ...
            modelBuilder.Entity("be_adminsisters.Persistence.Entities.UserAchievement", b =>
                {
                    b.HasOne("be_adminsisters.Persistence.Entities.Achievement", "Achievement")
                        .WithMany()
                        .HasForeignKey("AchievementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_achievement_achievements_achievement_id");
                    ...
                    b.HasOne("be_adminsisters.Persistence.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_achievement_users_user_id");
